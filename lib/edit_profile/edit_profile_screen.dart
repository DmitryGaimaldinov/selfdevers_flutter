...
class _EditProfileScreenState extends ConsumerState<EditProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    ImageProvider? backgroundImageProvider =
        editProfileState.backgroundImageProvider;
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: editProfileState.saveState ==
                    EditProfileSaveState.savingInProgress
                          ...
                          PopupMenuItem<int>(
                              ...
                              onTap: () async {
                                ...
                                if (croppedImageData != null) {
                                  editProfileNotifier
                                      .setBackground(croppedImageData);
                                }
                              },
                              child: ListTile(
